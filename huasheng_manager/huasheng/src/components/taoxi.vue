     ...
     <!-- tiitle栏 -->
        <div style="padding-bottom:30px">
         ...
         <div class="top-title" style=" margin-top:42px; margin-left:18px; line-height: 50px;">
                <span class="el-icon-info"></span><span style="margin-left:10px">套系管理</span><span>&nbsp;&nbsp;/&nbsp;&nbsp;套系管理</span>
         </div>
        </div>
...
<!-- 分页 -->
        ...
        <el-form :model="ruleForm" :rules="rules"   ref="ruleForm"  size='medium'    class="demo-ruleForm">
            ...
            prop="sesmName"
            >
                <el-input type="text"  placeholder="请输入套系名" v-model.number="ruleForm.sesmName" autocomplete="off">
            ...
            prop="price"
            >
                <el-input type="text"  placeholder="请输入价格" v-model.number="ruleForm.price" autocomplete="off">
                 <template slot="prepend"><i class="el-icon-edit"></i></template>
                </el-input>
            </el-form-item>
...
// 表单验证
        ...
        var validateSesmName = (rule, value, callback) => {
            if (value === '') {
                callback(new Error('套系名不能为空'));
            }else{
                callback();
            }
        ...
        return{
            ...
            rules: {
                    ...
                    sesmName: [
                        { validator: validateSesmName, trigger: 'blur' }
                    ],
                    price: [
...
// ------------------------------------------------------------弹窗图片处理-------------------------------------------------------------------------------------------------------------------
        ...
        addMost(){
            ...
            this.submitType="add";
            this.upPictureUrl=url.server+url.scInsertBySesm
            this.upfileList=[]
            this.ifImgChange=false
            this.$nextTick(() => {
            this.$refs['ruleForm'].resetFields();
        ...
        changeRow(index, rows){
            ...
            this.upPictureUrl=url.server+url.scUpdateBySesm
        },
          ...
          if (valid) {
            ...
            if(this.submitType=="add"){
               ...
               this.updateSelct();
                ...
                this.pppss.sesmName=this.ruleForm.sesmName
                this.pppss.price=this.ruleForm.price
            ...
            if(this.submitType=="change"){
                ...
                if(this.ifImgChange){     //图片修改
                    ...
                    postRequest(url.scUpdateBySesm,{
                        sesmName:this.ruleForm.sesmName,
      ...
      beforeAvatarUpload(file) {
        ...
        deletMost(){
            ...
            postRequest(url.scDeleteBySesm, {
                   ids:chooseStrId,
                   urls:chooseStrUrl
                }).then(data=> {
...
// f分页
      ...
      handleCurrentChange(val) {
        ...
        this.initSelectAll(this.tableData)
         ...
         initSelectAll(pamas){
             postRequest(url.scSelectBySesm, pamas).then(data=> {
