<template>
    <div class="userMessage  content">
     <!-- tiitle栏 -->
        <div style="padding-bottom:30px">
         ...
         <div class="top-title" style=" margin-top:42px; margin-left:18px; line-height: 50px;">
                <span class="el-icon-info"></span><span style="margin-left:10px">在线看店</span><span>&nbsp;&nbsp;/&nbsp;&nbsp;在线看店</span>
         </div>
        </div>
    ...
    <!-- 条件搜索 -->
        <div style="position:relative">
            ...
            <el-form-item  label="type类型" style="margin-left:20px;display:none;" prop="typeV">
...
<!-- 分页 -->
        ...
        <el-form :model="ruleForm" :rules="rules"   ref="ruleForm"  size='medium'    class="demo-ruleForm">
            ...
            prop="description"
            >
                <el-input type="textarea"  placeholder="请输入描述" v-model.number="ruleForm.description" autocomplete="off">
            ...
            prop="hall"
            >
                <el-input type="text"  placeholder="请输入厅名" v-model.number="ruleForm.hall" autocomplete="off">
                 <template slot="prepend"><i class="el-icon-edit"></i></template>
                </el-input>
            </el-form-item>
            ...
            prop="maxTable"
            >
                <el-input type="text"  placeholder="请输入最大桌数" v-model.number="ruleForm.maxTable" autocomplete="off">
                 <template slot="prepend"><i class="el-icon-edit"></i></template>
                </el-input>
            </el-form-item>
            ...
            prop="minimumPrice"
            >
                <el-input type="text"  placeholder="请输入起订价格" v-model.number="ruleForm.minimumPrice" autocomplete="off">
                 <template slot="prepend"><i class="el-icon-edit"></i></template>
                </el-input>
            </el-form-item>
            ...
            prop="siteAddress"
            >
                <el-input type="text"  placeholder="请输入地址" v-model.number="ruleForm.siteAddress" autocomplete="off">
                 <template slot="prepend"><i class="el-icon-edit"></i></template>
                </el-input>
            </el-form-item>
            ...
            prop="storeName"
            >
                <el-input type="text"  placeholder="请输入店名" v-model.number="ruleForm.storeName" autocomplete="off">
                 <template slot="prepend"><i class="el-icon-edit"></i></template>
                </el-input>
            </el-form-item>
            ...
            prop="undertakeNumber"
            >
                <el-input type="text"  placeholder="请输入承办桌数" v-model.number="ruleForm.undertakeNumber" autocomplete="off">
                 <template slot="prepend"><i class="el-icon-edit"></i></template>
                </el-input>
            </el-form-item>
...
// 表单验证
        ...
        var  validateDescription="" , validateHall="", validateMaxTable="", validateMinimumPrice="",
            validateSiteAddress="", validateSort="", validateStoreName="", validateUndertakeNumber=""

        validateDescription =validateHall =validateMaxTable =validateMinimumPrice =
        validateSiteAddress =validateSort =validateStoreName =validateUndertakeNumber = (rule, value, callback) => {
         if (value === '') {
        ...
        return{
            ...
            rules: {
                    ...
                    hall: [
                        { validator: validateHall, trigger: 'blur' }
                    ],
                    maxTable: [
                        { validator: validateMaxTable, trigger: 'blur' }
                    ],
                    minimumPrice: [
                        { validator: validateMinimumPrice, trigger: 'blur' }
                    ],
                    siteAddress: [
                    ...
                    undertakeNumber: [
                        { validator: validateUndertakeNumber, trigger: 'blur' }
                    ],
...
// ------------------------------------------------------------弹窗图片处理-------------------------------------------------------------------------------------------------------------------
        ...
        addMost(){
            ...
            this.submitType="add";
            this.upPictureUrl=url.server+url.scInsertByOws
            this.upfileList=[]
            this.ifImgChange=false
        ...
        changeRow(index, rows){
            ...
            this.ruleForm={
                ...
                maxTable:rows[index].maxTable,
                siteAddress:rows[index].siteAddress,
                minimumPrice:rows[index].minimumPrice,
                sort:rows[index].sort,
                storeName:rows[index].storeName,
                undertakeNumber:rows[index].undertakeNumber,
                hall:rows[index].hall,
            ...
            this.upPictureUrl=url.server+url.scUpdateByOws
        },
        ...
        this.$refs[formName].validate((valid) => {
          ...
          if (valid) {
            ...
            if(this.submitType=="add"){
                ...
                this.pppss.maxTable=this.ruleForm.maxTable
                this.pppss.minimumPrice=this.ruleForm.minimumPrice
                this.pppss.siteAddress=this.ruleForm.siteAddress
                this.pppss.sort=this.ruleForm.sort
                this.pppss.storeName=this.ruleForm.storeName
                this.pppss.undertakeNumber=this.ruleForm.undertakeNumber
                this.pppss.hall=this.ruleForm.hall
            ...
            if(this.submitType=="change"){
                ...
                if(this.ifImgChange){     //图片修改
                    ...
                    postRequest(url.scUpdateByOws,{
                        description:this.ruleForm.description,
                        maxTable:this.ruleForm.maxTable,
                        minimumPrice:this.ruleForm.minimumPrice,
                        siteAddress:this.ruleForm.siteAddress,
                        sort:this.ruleForm.sort,
                        storeName:this.ruleForm.storeName,
                        undertakeNumber:this.ruleForm.undertakeNumber,
                        hall:this.ruleForm.hall,
                        id:this.changeId,
                        file:""
                    }).then(data=> {
...
// f分页
      ...
      handleCurrentChange(val) {
        ...
        this.initSelectAll(this.tableData)
         ...
         initSelectAll(pamas){
             postRequest(url.scSelectByOws, pamas).then(data=> {
